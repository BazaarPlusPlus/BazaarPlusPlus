...
The documentation inventory, and the rules for changing it. When to open each document is decided once, in `AGENTS.md`'s header table — this file does not repeat those triggers.
...
- [agents/](agents/) — how agents use this repo: the issue tracker, the glossary, and the `AGENTS.md` rule-admission policy.
